...
echo $javascript->link('usr_dependencia/crear_solicitud_mantenimiento');
?>
...
<div id="col_derecha">
	<div id="titulo_pagina" align="center">Realizar una Solicitud de Mantenimiento</div>
	...
	<div id="contenido_vista">
		<form id="solicitud_mantenimiento" name="solicitud_mantenimiento" action="/solicitudes/crear" method="post" >
			...
			<input type="hidden" value="<?php echo $usuario['cedula']; ?>" name="data[Solicitud][cedula_usuario]" id="h_cedula_usuario"/>
			<input type="hidden" value="<?php echo $usuario['Cencos_id']; ?>" name="data[Solicitud][Cencos_id]" />
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0"><tbody>
				...
				<tr align="left">
					...
					<td colspan="3"><?php echo $usuario['edificio']; ?></td>
				</tr>
				...
				<tr align="left">
					...
					<td colspan="3"><?php echo $usuario['dependencia']; ?></td>
				</tr>
				...
				<tr align="left">
					...
					<td colspan="3"><?php echo $usuario['nombre']; ?></td>
				</tr>
				...
				<tr align="left">
					...
					<td colspan="3"><?php echo $usuario['cargo']; ?></td>
				</tr>
				...
				<tr align="left">
					...
					<td colspan="3"><?php echo $usuario['email']; ?></td>
				</tr>
				...
				<tr align="left">
					...
					<td colspan="3"><?php echo $usuario['telefono']; ?></td>
				</tr>
