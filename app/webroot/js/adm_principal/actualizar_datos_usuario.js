...
$(document).ready(function()
{
	...
	if ( jQuery('#h_cedula').val() == '1' )
	{
		jQuery('#cedula').attr('disabled', 'disabled');
	}
	...
	$('#usuario').submit(function()
	{
		...
		$('#cedula').val(jQuery.trim($('#cedula').val()));
		...
		nv = nombre_vacio();
		tv = telefono_vacio();
		ccl = cedula_con_logica('h_cedula', 'cedula');
		...
		if ( nv==false && tv==false && ccl==true && lcl==true && clv==true && ecl==true )
		{
